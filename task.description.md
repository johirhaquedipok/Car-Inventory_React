...
6. There will be a small form on the `inventory/:id` page. The form will say, restock the items. You will have an input field where you can put some numbers. And hitting the button will increase the quantity of the item.👍
